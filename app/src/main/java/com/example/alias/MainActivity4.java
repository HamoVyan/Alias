...
import com.example.alias.Pattern.Global_data;
...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*if ( score1_int == win_score_int || score1_int > win_score_int ) {
            ...
            team1_win = true;
            intent.putExtra("team1_win", team1_win);
        } else if ( score2_int == win_score_int || score2_int > win_score_int ) {
            Intent intent = new Intent(MainActivity4.this, MainActivity7.class);
            startActivity(intent);
            team2_win = true;
            intent.putExtra("team2_win", team2_win);
        ...
        if ( MainActivity6.isColor1Selected ) {
            main4.setBackgroundColor(white);
            score.setTextColor(black);
            best_score.setTextColor(black);
            play.setBackgroundColor(black);
            play.setTextColor(white);
            team1.setTextColor(black);
            team2.setTextColor(black);
            crown.setImageResource(R.drawable.crown_black);
        } else if ( MainActivity6.isColor2Selected ) {
            main4.setBackgroundColor(dark_emerald_green);
            score.setTextColor(pure_gold);
            best_score.setTextColor(pure_gold);
            play.setBackgroundColor(pure_gold);
            play.setTextColor(dark_emerald_green);
            team1.setTextColor(pure_gold);
            team2.setTextColor(pure_gold);
            crown.setImageResource(R.drawable.crown_pure_gold);
        } else if ( MainActivity6.isColor3Selected ) {
            main4.setBackgroundColor(yellow);
            score.setTextColor(black);
            best_score.setTextColor(black);
            play.setBackgroundColor(black);
            play.setTextColor(yellow);
            team1.setTextColor(black);
            team2.setTextColor(black);
            crown.setImageResource(R.drawable.crown_black);
        } else if ( MainActivity6.isColor4Selected ) {
            main4.setBackgroundColor(red);
            score.setTextColor(black);
            best_score.setTextColor(black);
            play.setBackgroundColor(black);
            play.setTextColor(red);
            team1.setTextColor(black);
            team2.setTextColor(black);
            crown.setImageResource(R.drawable.crown_black);
        } else if ( MainActivity6.isColor5Selected ) {
            main4.setBackgroundColor(teal);
            score.setTextColor(coral);
            best_score.setTextColor(coral);
            play.setBackgroundColor(coral);
            play.setTextColor(teal);
            team1.setTextColor(coral);
            team2.setTextColor(coral);
            crown.setImageResource(R.drawable.crown_coral);
        } else if ( MainActivity6.isColor6Selected ) {
            main4.setBackgroundColor(blooming_dahlia);
            score.setTextColor(purple);
            best_score.setTextColor(purple);
            play.setBackgroundColor(purple);
            play.setTextColor(blooming_dahlia);
            team1.setTextColor(purple);
            team2.setTextColor(purple);
            crown.setImageResource(R.drawable.crown_purple);
        } else if ( MainActivity6.isColor7Selected ) {
            main4.setBackgroundColor(orange);
            score.setTextColor(black);
            best_score.setTextColor(black);
            play.setBackgroundColor(black);
            play.setTextColor(orange);
            team1.setTextColor(black);
            team2.setTextColor(black);
            crown.setImageResource(R.drawable.crown_black);
        } else if ( MainActivity6.isColor8Selected ) {
            main4.setBackgroundColor(light_blue);
            score.setTextColor(orange);
            best_score.setTextColor(orange);
            play.setBackgroundColor(orange);
            play.setTextColor(light_blue);
            team1.setTextColor(orange);
            team2.setTextColor(orange);
            crown.setImageResource(R.drawable.crown_orange);
        }
        /*Colors*/
    }
